...
public class Politics extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        category_image.setImageResource(intent.getIntExtra("Category Image",R.drawable.politics));
        ...
        reference_score=FirebaseDatabase.getInstance().getReference().child("Score").child("CategoryPreviousScore").child("Category5");
    ...
    private void updateQuestion() {
        ...
        if (total >5) {
            ...
            getIntent().putExtra("Category Image",R.drawable.politics);
            reference_score.child("Category Name").setValue(category_name).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    if (task.isSuccessful()){
                        Toast.makeText(Politics.this,"Score Saved",Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(Politics.this,"Could'nt Save the Score",Toast.LENGTH_SHORT).show();
                    }
                }
            });
