...
public class Sports extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference_score=FirebaseDatabase.getInstance().getReference().child("Score").child("CategoryPreviousScore").child("Category6");
    ...
    private void updateQuestion() {
        ...
        if (total >5) {
            ...
            ref=reference.child("Sports").child(arrayList.get(iterator));
