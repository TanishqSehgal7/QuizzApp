...
public class Technology extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        category_image.setImageResource(intent.getIntExtra("Category Image",R.drawable.technology));
        ...
        reference_score=FirebaseDatabase.getInstance().getReference().child("Score").child("CategoryPreviousScore").child("Category7");
    ...
    private void updateQuestion() {
        ...
        if (total >5) {
            ...
            img.setImageResource(getIntent().getIntExtra("Category Image",R.drawable.technology));
            ...
            getIntent().putExtra("Category Image",R.drawable.technology);
            reference_score.child("Category Name").setValue(category_name).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    if (task.isSuccessful()){
                        Toast.makeText(Technology.this,"Score Saved",Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(Technology.this,"Could'nt Save the Score",Toast.LENGTH_SHORT).show();
                    }
                }
            });
            ...
            ref=reference.child("Technology").child(arrayList.get(iterator));
