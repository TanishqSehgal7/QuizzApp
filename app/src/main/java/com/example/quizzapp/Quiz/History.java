...
public class History extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        category_image.setImageResource(intent.getIntExtra("Category Image",R.drawable.history));
    ...
    private void updateQuestion() {
        ...
        if (total >5) {
            ...
            img.setImageResource(getIntent().getIntExtra("Category Image",R.drawable.history));
